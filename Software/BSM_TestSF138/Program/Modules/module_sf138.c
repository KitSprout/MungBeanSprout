...
void SF138_Config( void )
{
  ...
  /* GPIO Clk Init *************************************************************/
  RCC_AHBPeriphClockCmd(SF138_A0_GPIO_CLK, ENABLE);
  RCC_AHBPeriphClockCmd(SF138_A1_GPIO_CLK, ENABLE);
  RCC_AHBPeriphClockCmd(SF138_A2_GPIO_CLK, ENABLE);
  RCC_AHBPeriphClockCmd(SF138_EN_GPIO_CLK, ENABLE);
